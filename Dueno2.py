...
#Los elementos de la lista son: 23546987,“Maria”,“Perez”,4789689,“Pueyrredon  811” que representan los datos del dueño de un perro (DNI, nombre, apellido, teléfono y dirección) 

Dueno2 = [23546987,"Maria","Perez",4789689,"Pueyrredon 811"];

print ([Dueno2[i] for i in (1,3,4)])